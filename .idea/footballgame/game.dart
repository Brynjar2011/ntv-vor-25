...
void main(){
    ...
    List<footballPlayer> barcelonaPlayers = [
      footballPlayer(squadNumber: 1, firstName: "Marc-André", lastName: "ter Stegen", : "Goalkeeper"),
    ...
    List<footballPlayer> liverpoolPlayers = [
      footballPlayer(squadNumber: 1, firstName: "Alisson", lastName: "Becker", : "Goalkeeper"),
    ...
    print(liverpool.players[0].getName())
  }
