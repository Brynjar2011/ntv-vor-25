...
void main() {
  ...
  List<footballPlayer> barcelonaPlayers = [
    footballPlayer(squadNumber: 1,
        firstName: "Marc-André",
        lastName: "ter Stegen",
        position: "Goalkeeper"),
    footballPlayer(squadNumber: 2,
        firstName: "João",
        lastName: "Cancelo",
        position: "Defender"),
    footballPlayer(squadNumber: 3,
        firstName: "Ronald",
        lastName: "Araújo",
        position: "Defender"),
    footballPlayer(squadNumber: 4,
        firstName: "Andreas",
        lastName: "Christensen",
        position: "Defender"),
    footballPlayer(squadNumber: 5,
        firstName: "Alejandro",
        lastName: "Balde",
        position: "Defender"),
    footballPlayer(squadNumber: 6,
        firstName: "Frenkie",
        lastName: "de Jong",
        position: "Midfielder"),
    footballPlayer(squadNumber: 7,
        firstName: "Pedri",
        lastName: "González",
        position: "Midfielder"),
    footballPlayer(squadNumber: 8,
        firstName: "Gavi",
        lastName: "Paez",
        position: "Midfielder"),
    footballPlayer(squadNumber: 9,
        firstName: "Robert",
        lastName: "Lewandowski",
        position: "Forward"),
    footballPlayer(squadNumber: 10,
        firstName: "João",
        lastName: "Félix",
        position: "Forward"),
    footballPlayer(squadNumber: 11,
        firstName: "Raphinha",
        lastName: "Belloli",
        position: "Forward"),
  ];
  ...
  footballTeam barcelona = footballTeam(name: "FC Barcelona",
      league: "La Liga",
      country: "Spain",
      players: barcelonaPlayers);
  footballTeam liverpool = footballTeam(name: "Liverpool FC",
